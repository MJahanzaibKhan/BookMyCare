...
const Home = () => {
    ...
    const testimonials = [
      {
          name: "John Doe",
          text: "Book My Care has revolutionized how I manage my healthcare. It's so easy to use!",
          image: "https://randomuser.me/api/portraits/men/32.jpg",
      },
      {
          name: "Jane Smith",
          text: "I love how I can access all my medical information in one place. Great job, Book My Care!",
          image: "https://randomuser.me/api/portraits/women/44.jpg",
      },
      {
          name: "Mike Johnson",
          text: "Booking appointments has never been easier. Book My Care is a game-changer!",
          image: "https://randomuser.me/api/portraits/men/22.jpg",
      },
      {
          name: "Emily Davis",
          text: "The staff is incredibly helpful and caring. I highly recommend Book My Care!",
      ...
      {
          name: "Mary Brown",
          text: "I appreciate the convenience of managing everything online. Thank you, Book My Care!",
    ...
    <div className="md:w-1/2 md:pl-8 flex flex-col justify-between"> {}
      ...
      <div className="flex-grow"> {}
        <p className="text-gray-600 mb-4 text-[1.1rem] font-montserrat">
          Book My Care is a cutting-edge healthcare management system
        ...
        <p className="text-gray-600 mb-4 text-[1.1rem] font-montserrat">
          With Book My Care, you can easily manage appointments, access
    ...
    <div className="container mx-auto px-4">
        ...
        <section className="cta bg-primary text-light py-20 rounded-3xl mx-4 mb-4">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="mb-8">
              Join Book My Care today and experience the future of healthcare
              management.
            </p>
            <Link to="/signup">
              <motion.button
